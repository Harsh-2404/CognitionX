...
class Student:
    def __init__(self,root):
        ...
        #1 img
        img=Image.open(r"C:\react files\CognitionX\college_images\di.jpg")
        ...
        #2 img
        img1=Image.open(r"C:\react files\CognitionX\college_images\facialrecognition.png")
        ...
        #3 im2
        img2=Image.open(r"C:\react files\CognitionX\college_images\Train.jpg")
        img2=img2.resize((570,130),Image.ANTIALIAS)
        ...
        #bg img
        img3=Image.open(r"C:\react files\CognitionX\college_images\wp.jpg")
        ...
        #left lable frame 
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Deatails",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=730,height=580)


        img_left=Image.open(r"C:\react files\CognitionX\college_images\Train.jpg")
        img_left=img2.resize((720,130),Image.ANTIALIAS)
        ...
        dep_combo["value"]=("Select Department","CSE","CSIT","IT","CS","Civil")
        dep_combo.current(0)
        ...
        course_combo["value"]=("Select Course","SE","WT","ITSS","CN","BD","SPM")
        ...
        class_div_lable=Label(class_student_frame,text="Class Didvision",font=("times new roman",13,"bold"),bg="white")
        ...
        #right lable frame 
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Deatails",font=("times new roman",12,"bold"))
        Right_frame.place(x=750,y=10,width=740,height=580)

        img_right=Image.open(r"C:\react files\CognitionX\college_images\imgref3_orig.jpg")
        ...
        search_lable=Label(Search_frame,text="Search By:",font=("times new roman",15,"bold"),bg="red",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Loveuyar1@",database="facial_recognition")
...
#===================== update function ====================
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Loveuyar1@",database="facial_recognition")
                    my_cursor=conn.cursor()
                    my_cursor.execute("Update student set dep=%s,course=%s,year=%s,semester=%s,std_id=%s,std_name%s,div=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,PhotoSample=%s where student_id=%",(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                        self.var_semester.get(),
                    ...
                    if  not Upadate:
                        return
                messagebox.showinfo("Success","Student details sucessfully update complet",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
  ...
  #============= delete section ================
        ...
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Loveuyar1@",database="facial_recognition")
                    my_cursor=conn.cursor()
                    sql="delete from student were student_id=%s"
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","Sucessfully delete student detials",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due to:{str(es)}",parent=self.root)
    ...
    #============= Lode predifiend data on face frontals from open cv=============
